...
`];class r extends e{static properties={_hasMedia:{type:Boolean,attribute:!1}};static styles=[i,o];constructor(){super(),this._hasMedia=!1}firstUpdated(){this.shadowRoot.querySelector('slot[name="media"]').addEventListener("slotchange",(()=>{this._hasMedia=this.shadowRoot?.querySelector('slot[name="media"]').assignedNodes().length,this._hasMedia?document.documentElement.classList.add("wm-has-stage"):document.documentElement.classList.remove("wm-has-stage")}))}render(){const t={"content--media":this._hasMedia};return a`
