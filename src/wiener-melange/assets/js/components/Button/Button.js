...
:host([size="small"]) ::slotted(:is(button, a)) {
  --button-font-size: 0.8rem;
}
`];class a extends o{static properties={alignment:{type:String,reflect:!0},color:{type:String,reflect:!0},kind:{type:String,reflect:!0},full:{type:Boolean,reflect:!0},size:{type:String,reflect:!0}};static styles=[n,e];constructor(){super(),this.kind="primary",this.full=!1,this.alignment=void 0,this.color=void 0,this.size=void 0}render(){return r`
      <slot></slot>
